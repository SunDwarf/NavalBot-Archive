...
def on_message(func: typing.Callable[[NavalClient, discord.Message]]) -> types.FunctionType:
    """
...
def on_generic_event(func: typing.Callable[[NavalClient, dict]]) -> types.FunctionType:
    """
